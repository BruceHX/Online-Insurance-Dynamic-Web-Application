...
<script>
function check() {
	var a = document.ff.pname.value;
	var b = document.ff.pid.value;
...
<body bgcolor=skyblue>
	...
	<div style="text-align: center;">
		...
		<div>
			...
			<h4>Policy Registration</h4>
			<form action="policyregisaction.jsp" name="ff" method="get"
				onsubmit="return check()">
				Policy Name: <br> <input type="text" name="pname" id="pname"
					style="background: cadetblue; height: 28px; width: 250px;"><br>
				<br> Policy Id: <br> <input type="text" name="pid" id="pid"
					style="background: cadetblue; height: 28px; width: 250px;"><br></br>

...
<body bgcolor=skyblue>
	...
	<div style="color: RED; font-size =4px; font-family: Times New Roman;">
		...
		<ul id="menu">
			<li>&emsp;<a href="policyholderpage.jsp" class="current">Home</a>&emsp;
			</li>
			...
			<li>&emsp;<a href="policyholderlog.jsp">Logout</a>&emsp;
			</li>
		</ul>
		<br> <br>
	...
	<%
	 ...
	 ResultSet rs2 = st2.executeQuery("select * from  policyholderregispage ");
	 while(rs2.next()){
	...
	<br><br>
	<h1 style="color: yellow; text-align:center;">Stay Tuned...<br>Coming Soon...</h1>
